...
#define ibz_complex_pow_mod                             SQISIGN_NAMESPACE_GENERIC(ibz_complex_pow_mod)
...
#undef quat_constant_random_O0_ideal_norm_universal 
#undef quat_generate_random_O0_ideal_norm_non_prime 
...
#define quat_constant_random_O0_ideal_norm_universal    SQISIGN_NAMESPACE_GENERIC(quat_constant_random_O0_ideal_norm_universal)
#define quat_generate_random_O0_ideal_norm_non_prime    SQISIGN_NAMESPACE_GENERIC(quat_generate_random_O0_ideal_norm_non_prime)
